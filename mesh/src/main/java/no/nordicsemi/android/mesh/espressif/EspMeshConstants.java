...
public class EspMeshConstants {
    public static final UUID UUID_PROVISIONING_SERVICE = UUID.fromString("00001827-0000-1000-8000-00805f9b34fb");
    public static final UUID UUID_PROVISIONING_CHAR_WRITE = UUID.fromString("00002adb-0000-1000-8000-00805f9b34fb");
    public static final UUID UUID_PROVISIONING_CHAR_NOTIFICATION = UUID.fromString("00002adc-0000-1000-8000-00805f9b34fb");

    public static final UUID UUID_PROXY_SERVICE = UUID.fromString("00001828-0000-1000-8000-00805f9b34fb");
    public static final UUID UUID_PROXY_CHAR_WRITE = UUID.fromString("00002add-0000-1000-8000-00805f9b34fb");
    public static final UUID UUID_PROXY_CHAR_NOTIFICATION = UUID.fromString("00002ade-0000-1000-8000-00805f9b34fb");
    ...
    public static final int PROXY_TYPE_PROXY_CONFIGURATION = 0x02;
    ...
    public static final int ADDRESS_UNASSIGNED = 0x0000;
    public static final int ADDRESS_UNICAST_MIN = 0x0001;
    public static final int ADDRESS_UNICAST_MAX = 0x7fff;
    public static final int ADDRESS_VIRTUAL_MIN = 0x8000;
    public static final int ADDRESS_VIRTUAL_MAX = 0xbfff;
    public static final int ADDRESS_GROUP_MIN = 0xc000;
    public static final int ADDRESS_GROUP_MAX = 0xffff;

    public static final int ADDRESS_OTA_GROUP = 0xf000;

    public static final int ADDRESS_FAST_PROV_GROUP_MIN = ADDRESS_GROUP_MIN;

    public static final int APP_ADDRESS_DEFAULT = 0x0001;
    public static final int APP_KEY_INDEX_DEFAULT = 0x0001;

    public static final int NET_KEY_INDEX_DEFAULT = 0x0001;
}
