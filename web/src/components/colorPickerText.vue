  ...
  methods: {
    ...
    getParents: function (e, parent, andSelf) {
      ...
      while (true) {
        ...
        if (curTarget != null && typeof (curTarget) !== 'undefined' && curTarget !== '') {
          arr.push(curTarget)
        }
        if (curTarget.parentNode != null && typeof (curTarget.parentNode) !== 'undefined' && curTarget.parentNode !== '') {
    ...
    updateDisplay: function () {
      ...
      self.dom.slMarker.style.top = Math.round(self.square * (0.5 - self.hsl[2]) + self.width / 2) + 'px'
